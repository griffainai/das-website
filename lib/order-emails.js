...
const { brandShell } = require('./email-brand');
function shell(innerHtml, opts) {
  const o = opts || {};
  return brandShell({
    preheader: o.preheader || 'Driver Appreciation Solutions',
    eyebrow: o.eyebrow || 'Order confirmation',
    title: o.title || 'Order<br>confirmed',
    sub: o.sub || '',
    photo: o.photo,
    tableRows: innerHtml,
  });
...
function buildCustomerReceiptHtml(o) {
  ...
  const inner = `
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="vertical-align:top;width:50%;padding-right:8px">
            <div style="font-size:11px;text-transform:uppercase;letter-spacing:.5px;color:#5A6478;font-weight:700;margin-bottom:6px">Billing</div>
          ...
          <td style="vertical-align:top;width:50%;padding-left:8px">
            <div style="font-size:11px;text-transform:uppercase;letter-spacing:.5px;color:#5A6478;font-weight:700;margin-bottom:6px">Shipping</div>
    ...
    <tr><td style="padding:24px 32px 0">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
        <thead><tr>
          <th style="text-align:left;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;letter-spacing:.5px;border-bottom:2px solid #E5E7EB">Item</th>
          <th style="text-align:center;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;letter-spacing:.5px;border-bottom:2px solid #E5E7EB">Qty</th>
          <th style="text-align:right;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;letter-spacing:.5px;border-bottom:2px solid #E5E7EB">Unit</th>
          <th style="text-align:right;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;letter-spacing:.5px;border-bottom:2px solid #E5E7EB">Total</th>
        </tr></thead>
    ...
    <tr><td style="padding:28px 32px 32px">
      <p style="margin:0;font-size:12px;color:#5A6478;line-height:1.6">
  ...
  return shell(inner, {
    preheader: `Order ${o.orderNumber || ''} confirmed — thank you.`,
    eyebrow: 'Order confirmation & receipt',
    title: 'Order<br>confirmed',
    photo: 'https://www.driverappreciationsolutions.com/images/email/receipt-hero.jpg',
  });
}
...
function buildInternalNotificationHtml(o) {
    ...
    return `
      <tr>
        <td style="padding:10px 8px;border-bottom:1px solid #EEF1F6;vertical-align:top">
          ...
          ${sku ? `<div style="color:#5A6478;font-size:11px;margin-top:2px">SKU: ${esc(sku)}</div>` : ''}
        </td>
        <td style="padding:10px 8px;border-bottom:1px solid #EEF1F6;text-align:center;color:#374151;font-size:14px;vertical-align:top">${esc(qty)}</td>
        <td style="padding:10px 8px;border-bottom:1px solid #EEF1F6;text-align:right;color:#374151;font-size:14px;vertical-align:top">${money(unit)}</td>
  ...
  const inner = `
    ...
    <tr><td style="padding:20px 32px 0">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
        <thead><tr>
          <th style="text-align:left;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;border-bottom:2px solid #E5E7EB">Item</th>
          <th style="text-align:center;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;border-bottom:2px solid #E5E7EB">Qty</th>
          <th style="text-align:right;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;border-bottom:2px solid #E5E7EB">Unit</th>
          <th style="text-align:right;padding:0 8px 8px;font-size:11px;color:#5A6478;font-weight:700;text-transform:uppercase;border-bottom:2px solid #E5E7EB">Total</th>
        </tr></thead>
    ...
    <tr><td style="padding:28px 32px 32px">
      <p style="margin:0;font-size:12px;color:#5A6478">Internal notification · Driver Appreciation Solutions order system.</p>
    </td></tr>`;
  return shell(inner);
}
