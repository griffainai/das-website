...
(function (root, factory) {
  ...
  // premium 1.45 -> 1.50 (2026-07-16): the site published $74.99 for premium in 5
  // places, but 49.99 x 1.45 = $72.49 — a price that appears nowhere. 49.99 x 1.50
  // = $74.99 exactly (implied multiplier 1.5001), so 1.45 was the typo and the site
  // was undercharging $2.50/unit against its own advertised price. Side effect:
  // das-003 premium 86.99 -> 89.99.
  var KIT_MULTIPLIERS = {
    standard:   1.00,
    premium:    1.50,
    enterprise: 1.95,
