/* ⚠️ PARKED — NOT A LIVE ENDPOINT.
 *
 * The leading underscore is deliberate: Vercel does not route or serve `api/_*` files, so this
 * ships with the repo but is unreachable and costs nothing. **To activate it, rename the file
 * without the underscore** — and read the guard-wall doctrine first
 * (griffain-agency-workspace/06_operations/AI-ENDPOINT-GUARD-WALL.md), because it becomes a
 * public endpoint the moment you do.
 *
 * RESCUED 2026-08-14 from `das-web-pdf-download/`, an orphaned git worktree that was never a live
 * project and has now been deleted. This file existed ONLY there — it is the sole artefact of that
 * folder worth keeping. Its own note below says publishing does not require this endpoint, so it
 * was an optional enhancement that never merged.
 */
/* =============================================================
